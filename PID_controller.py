...
class Pid():
    ...
    def _odom_callback(self, msg):
        ...
        error = math.sqrt((x - self.x_values[self.i])**2 + (y - self.y_values[self.i])**2)
        #print("The error is ", error,"and index is", self.i)
    ...
    def spin(self):
        ...
        #while not rospy.is_shutdown():
            ...
            #print(self.x_values[i-1], " ", self.y_values[i-1])
...
def main():
    ...
    # Robot random walks.
    try:
        path = [(1.9000001028180122, 1.0000000894069672), (1.8000001013278961, 1.0000000894069672), (1.70000009983778, 1.0000000894069672), (1.6000000983476639, 1.0000000894069672), (1.5000000968575478, 1.0000000894069672), (1.4000000953674316, 1.0000000894069672), (1.3000000938773155, 1.0000000894069672), (1.2000000923871994, 1.0000000894069672), (1.1000000908970833, 1.0000000894069672), (1.0000000894069672, 1.0000000894069672), (0.90000008791685104, 1.0000000894069672), (0.80000008642673492, 1.0000000894069672), (0.7000000849366188, 1.0000000894069672), (0.60000008344650269, 1.0000000894069672), (0.50000008195638657, 1.0000000894069672), (0.40000008046627045, 1.0000000894069672), (0.30000007897615433, 1.0000000894069672), (0.20000007748603821, 1.0000000894069672), (0.10000007599592209, 1.0000000894069672), (7.4505805969238281e-08, 1.0000000894069672), (-0.09999992698431015, 1.0000000894069672), (-0.19999992847442627, 1.0000000894069672), (-0.29999992996454239, 1.0000000894069672), (-0.39999993145465851, 1.0000000894069672), (-0.49999993294477463, 1.0000000894069672), (-0.49999993294477463, 1.1000000908970833), (-0.59999993443489075, 1.1000000908970833), (-0.59999993443489075, 1.2000000923871994), (-0.59999993443489075, 1.3000000938773155), (-0.69999993592500687, 1.3000000938773155), (-0.79999993741512299, 1.3000000938773155), (-0.79999993741512299, 1.4000000953674316), (-0.89999993890523911, 1.4000000953674316), (-0.89999993890523911, 1.5000000968575478), (-0.99999994039535522, 1.5000000968575478), (-0.99999994039535522, 1.6000000983476639), (-0.99999994039535522, 1.70000009983778), (-1.0999999418854713, 1.70000009983778), (-1.1999999433755875, 1.70000009983778), (-1.2999999448657036, 1.70000009983778), (-1.3999999463558197, 1.70000009983778), (-1.4999999478459358, 1.70000009983778), (-1.5999999493360519, 1.70000009983778), (-1.6999999508261681, 1.70000009983778), (-1.7999999523162842, 1.70000009983778), (-1.8999999538064003, 1.70000009983778), (-1.9999999552965164, 1.70000009983778), (-2.0999999567866325, 1.70000009983778), (-2.1999999582767487, 1.70000009983778), (-2.2999999597668648, 1.70000009983778), (-2.3999999612569809, 1.70000009983778), (-2.499999962747097, 1.70000009983778), (-2.499999962747097, 1.8000001013278961), (-2.499999962747097, 1.9000001028180122), (-2.499999962747097, 2.0000001043081284), (-2.499999962747097, 2.1000001057982445), (-2.499999962747097, 2.2000001072883606), (-2.499999962747097, 2.3000001087784767), (-2.499999962747097, 2.4000001102685928), (-2.499999962747097, 2.500000111758709), (-2.499999962747097, 2.6000001132488251), (-2.499999962747097, 2.7000001147389412), (-2.499999962747097, 2.8000001162290573), (-2.499999962747097, 2.9000001177191734), (-2.499999962747097, 3.0000001192092896), (-2.499999962747097, 3.1000001206994057), (-2.5999999642372131, 3.1000001206994057), (-2.5999999642372131, 3.2000001221895218)]
        PID.follow(path)
    except rospy.ROSInterruptException:
        rospy.logerr("ROS node interrupted.")
